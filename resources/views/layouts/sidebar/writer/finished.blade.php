<div id="sidebar" class="sidebar py-3">
  ...
  <ul class="sidebar-menu list-unstyled">
     ...
     <li class="sidebar-list-item"><a href="/writer" data-toggle="collapse" data-target="#orders" aria-expanded="true" aria-controls="pages" class="sidebar-link active"><i class="o-document-1 mr-3 text-gray"></i><span>Orders</span></a>
