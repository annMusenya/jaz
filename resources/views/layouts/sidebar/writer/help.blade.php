<div id="sidebar" class="sidebar shrink show py-3">
  ...
  <ul class="sidebar-menu list-unstyled">
     ...
     <li class="sidebar-list-item"><a href="/writer" data-toggle="collapse" data-target="#orders" aria-expanded="false" aria-controls="pages" class="sidebar-link text-muted"><i class="o-document-1 mr-3 text-gray"></i><span>Orders</span></a>
            <div id="orders" class="collapse">
              <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
                <li class="sidebar-list-item"><a href="/writer" class="sidebar-link text-muted pl-lg-5">Available @if($availableNum)<span class="badge badge-primary badge-pill px-2 py-1 ml-2 text-white">{{$availableNum}}</span>@endif</a></li>
  ...
  <ul class="sidebar-menu list-unstyled">
    ...
    <li class="sidebar-list-item">
      ...
      <a href="/writer/help" class="sidebar-link active">
