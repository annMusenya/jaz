	...
	<tr>
		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h6 style="color:#333">{{$userName}},</h6>
						<p class="lead">You are receiving this email bacause we received a password reset request for your account. Follow this link to reset password <a class="callout" href="{{$link}}" target="blank">Reset Password &raquo;</a></p>
						<p style="font-size: 12px">This password reset link will expire in 60 minutes. If you did not request for password reset, ignore this email.</p>
                        <p style="margin-top:20px">Regards,</p>
                        <p style="margin-bottom:20px">Custom-Written.Com</p>
							...
							<tr>
								<td>
									<table align="left" class="column">
										<tr>
											<td>
												<h5 style="font-size:12px">Connect with Us:</h5>
									...
									<table align="left" class="column">
										<tr>
											<td>							
												<h5 style="font-size:12px">Contact Info:</h5>												
												<p><strong><a href="emailto:support@custom-written.com">support@custom-written.com</a></strong></p>
											</td>
										</tr>
									</table>
