		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h6>Leonard,</h6>
						<p class="lead">We notice that you've requested password recovery. If this is true, click this link to reset your accout password <a class="callout" href="#">password reset link &raquo;</a></p>
						<p>If you haven't requested password recovery, please ignore this message. However, if your account has been accessed by another person other than you, contact support, to report the case.</p>
