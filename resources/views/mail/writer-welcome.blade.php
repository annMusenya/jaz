		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h6>Leonard,</h6>
						<p class="lead">Congratulations for being selected to become a freelance writer with us. To access your account dashboard, visit <a class="callout" href="https://dashboard.custom-written.com/writer">my account &raquo;</a></p>
						<p>We are a company that takes pride in our services. We expect our freelance writers to maintain professionalism by strictly following our writer guidelines and maintaining high standards of quality paper writing. Our writers are rated based on performance. Top rated writers earn more and have the ability to bid for major projects, that pay more. Writers who fail to deliver have their accounts closed. Also, reported cases of plagiarism by a writer may lead to account suspension.</p>
						<!-- Callout Panel -->
						<p class="callout">
							If you need assistance on getting started, check our writer <a href="https://custom-written.com/writer-guidelines">guidelines &raquo;</a>
						</p><!-- /Callout Panel -->					
