		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h6>Leonard,</h6>
						<p class="lead">Thank you for making payment for order <strong>#23435465.</strong> We want to confirm that we have successfully received payment of amount <strong>$12.25</strong> through paypal. For transaction details, check out <a class="callout" href="https://dashboard.custom-written.com/payments">payments &raquo;</a> section, on your account.</p>
						<p>We are currently reviewing your order. A suitable writer will be immediately assigned to your order. Feel free to contact support for help.</p>
