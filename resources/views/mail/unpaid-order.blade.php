		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h6>Leonard,</h6>
						<p class="lead">Thank you for placing an order. Order <strong>#34234454</strong> has been created. Please make payment so that you get your paper within the specified deadline period. Click <a class="callout" href="#"> pay now &raquo;</a> to make payment.</p>
						<p>The cost of an order depends on urgency. The longer the deadline period, the lower the cost. Delay in payment reduces the time we will have to deliver the paper, which in turn increases the cost of an order.</p>
