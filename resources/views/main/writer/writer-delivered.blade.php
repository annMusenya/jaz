...
<section>
    <div class="row">
        <div class="col-lg-6 mb-4 text-left">
            <h5 class="h5 text-uppercase mb-1 text-muted">Delivered Orders</h5>
            <small class="text-muted">Orders that are sent to customer, awaiting approval.</small>
        </div>
    </div>
		...
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">
					<h5 class="text-uppercase mb-0 text-primary mb-1">Delivered Jobs({{$deliveredCount}})</h5>
					<small>These papers are approved by quality team. Awaiting customer approval.</small>
				</div>
				<div class="card-body">
    ...
    <div class="row">
        <div class="col-lg-12 text-center">
            ...
            <p class="h4 text-gray-500">You have no delivered orders.</p>
        </div>
    </div>
    @endif
