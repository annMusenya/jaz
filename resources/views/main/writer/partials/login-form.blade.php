<form id="writer-login" method="POST" action="/writer/login">
    @csrf
    ...
    <div class="form-group row">
        <div class="col-md-12">
            <input id="password" type="password" class="form-control border-0 shadow form-control-lg text-blue @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Password"> 
    ...
    <button id="writer-login-btn" type="button" class="btn btn-primary shadow px-5">{{ __('Login') }}</button><span class="h6 or"></span>
</form>