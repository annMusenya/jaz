            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-lg-4 text-right">
                        @if($order->order_status == 0 || $order->order_status == 1 || $order->order_status == 4 || $order->order_status == 5 ) <button class="btn btn-gray-500 text-center" data-toggle="modal" data-target="#upload-file">Upload Files<i class="fa fa-upload ml-2"></i></button>@endif
                        @include('main.writer.modals.upload-file')
                    </div>
                </div>
            </div>
            <div class="card-body">
