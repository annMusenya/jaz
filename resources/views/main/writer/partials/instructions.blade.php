            ...
            <div class="row">
                    <div class="col-lg-3">
                        <div class="left d-flex align-items-center">
                            <div class="text">
                              <p class="mb-0 d-flex align-items-center text-muted text-sm"><span>Payment:</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-9">
                        <div class="text-muted">
                                ...
                                @else
                                    <h6 class="text-sm text-success">Paid <i class="fa fa-check-circle ml-1"></i></h6>
                                @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    <div class="col-lg-3">
                        <div class="left d-flex align-items-center">
                            <div class="text">
                              <p class="mb-0 d-flex align-items-center text-muted text-sm"><span>Type of Paper:</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-9">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-lg-9">
                        <div class="text-muted">
                            <h6 class="text-sm text-blue">{{"$".number_format((float)(($order->writer_amount)),2,'.','')}}</h6>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-9">
                        <div class="text-muted">
                            ...
                            @php
                                ...
                                echo ($pages." ,".$spacing." spaced " . "(" . $words . " words)");
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-lg-9">
                        <div class="text-muted">
                            <input class="hidden" name="deadline" value="{{$order->writer_period}}">
