...
@include ('layouts.sidebar.writer.finished')
...
<section>
    <div class="row">
        <div class="col-lg-6 mb-4 text-left">
            ...
            <small class="text-muted">These are delivered orders that the customer has approved.</small>
        </div>
    </div>
		...
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">
					<h5 class="text-uppercase mb-0 text-primary mb-1">Available Orders({{$finishedCount}})</h5>
					<small>Orders that are available for bidding.</small>
				</div>
				<div class="card-body">
					<table id="finished-table" class="table card-text table-standard ks-table-lg">
							<thead>
    ...
    <div class="row">
        <div class="col-lg-12 text-center">
            <i class="fa fa-warning text-gray-200 msg-icon mb-4"></i>
