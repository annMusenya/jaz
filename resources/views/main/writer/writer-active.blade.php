...
<section>
    <div class="row">
        <div class="col-lg-6 mb-4 text-left">
            <h5 class="h5 text-uppercase mb-1 text-muted">Assigned Jobs</h5>
            <small class="text-muted">You have not been assigned any jobs.</small>
        </div>
    </div>
    @if ($activeCount)
    <div class="row mb-5">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">
					<h5 class="text-uppercase mb-0 text-primary mb-1">Your current Jobs({{$activeCount}})</h5>
				</div>
				<div class="card-body">
    ...
    <div class="row">
        <div class="col-lg-12 text-center">
            ...
            <p class="h4 text-gray-500">You have no active jobs. Bid to get assigned a job.</p>
        </div>
    </div>
    @endif
