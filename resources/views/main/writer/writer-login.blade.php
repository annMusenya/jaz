  ...
  <div class="container">
    ...
    <div class="row align-items-center py-5">
      ...
      <div class="col-lg-5 px-lg-4">
        ...
        <h2 class="mb-4">Writer Login</h2>

        <p class="text-muted">Earn by writing academic papers. Work at your own convenience. Visit our official <a href="#" target="blank">recruitment</a> page to apply.</p>

        @include ('main.writer.partials.login-form')
