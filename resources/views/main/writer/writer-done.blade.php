...
<section>
    <div class="row">
        <div class="col-lg-6 mb-4 text-left">
            <h5 class="h5 text-uppercase mb-1 text-muted">Done Orders</h5>
            <small class="text-muted">Orders that are being assessed by graders. They are yet to be delivered to customers.</small>
        </div>
    </div>
		...
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">
					...
					<small>Well done. The quality team with review your paper and deliver to customer.</small>
				</div>
				<div class="card-body">
    ...
    <div class="row">
        <div class="col-lg-12 text-center">
            ...
            <p class="h4 text-gray-500">You have no done orders.</p>
        </div>
    </div>
    @endif
