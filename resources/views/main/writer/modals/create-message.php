    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="create-message" method="POST" action="/writer/post-message/{{$order->id}}">
          ...
          <div class="row">
              <div class="col-lg-6 hidden">
                <div class="form-group">
                    ...
                    <input type="text" name="recipient_id" class="form-control hidden" value="{{$customerId}}">
                    <input type="text" name="recipient_name" class="form-control hidden" value="{{$customerName}}">
                </div>
              </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label>Message</label>
            <textarea rows="5" class="form-control text-sm" name="message" placeholder="Type your message here..."></textarea>
          </div>
