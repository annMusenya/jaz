            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-lg-4 text-right">
                        @if($order->order_status == 0 || $order->order_status == 1 || $order->order_status == 4 || $order->order_status == 5 || $order->order_status == 8 )<button class="btn btn-gray-500 text-right" type="button" data-toggle="modal" data-target="#create-message">New Message</button> @endif
                        @include('main.customer.modals.create-message')
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    @else
                        @foreach ($messages as $message)
                            <div class="msg-accordion px-4 py-3 d-flex align-items-center justify-content-between mb-3 roundy bg-gray-100" data-toggle="collapse" href="#messageContent{{$message->id}}" role="button" aria-expanded="false" aria-controls="messageContent">
                        ...
                        <div class="msg-collapse collapse mb-2 mt-3" id="messageContent{{$message->id}}">
                            ...
                            <!-- Reply Message -->
                            <div class="col-sm-6">
                                @include('main.customer.modals.reply-message')
