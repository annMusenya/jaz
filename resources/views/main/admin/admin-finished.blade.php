...
@include ('layouts.sidebar.admin-sidebar.finished')
...
<section>
    <div class="row">
        <div class="col-lg-6 mb-4 text-left">
            <h5 class="h5 text-uppercase mb-1 text-muted">Manage finished orders</h5>
            <small class="text-muted">An order is marked finished when a customer approves the final paper.</small>
        </div>
    </div>
		...
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">
					<h5 class="text-uppercase mb-0 text-primary mb-1">Finished Orders({{$finishedCount}})</h5>
					<small>Orders that have been completed and the customer has approved.</small>
				</div>
				<div class="card-body">
	...
	<div class="col-lg-12 text-center">
        <i class="fa fa-frown text-gray-300 msg-icon mb-4"></i>
        <p class="h6 text-gray-400">Sadly? You have no finished orders.</p>
  	</div>
